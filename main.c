...
#include "levels.h"
#include "progress.h"
#include "version.h"   // generated by build.ps1 — see .docflow/adr/0104-git-derived-build-version.md
...
static void DrawMenu(void) {
    ...
    DrawTextCentered("F11 fullscreen   P pause   F fps   ESC quit", GAME_W/2, 840, 22,
                     (Color){ 150, 170, 155, 180 });
#endif
    // build identity, bottom-right corner (see .docflow/adr/0007)
    Vector2 vm = MeasureTextEx(gFont, GAME_VERSION, 20, 2);
    DrawTextShadow(GAME_VERSION, GAME_W - vm.x - 22, GAME_H - 32, 20,
                   (Color){ 140, 162, 148, 170 });
}
// ui helpers ----------------------------------------------------------------
